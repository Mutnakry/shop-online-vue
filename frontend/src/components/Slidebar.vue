        ...
        <ul class="space-y-2 font-medium">
          ...
          <li v-if="user.rol !== 'manager'">
            ...
            >
              ...
              >
                <path
                  d="M16 2a1 1 0 0 0-1 1v4H5V3a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1h1v9a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V9h1a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1h-3Zm-6 4v5a1 1 0 0 1-1 1h-1V6h1a1 1 0 0 1 1 1Zm2 5h1v1h-1v-1Zm1 2v-1h-2v1h2Zm0-3h-2v-1h2v1Zm0-2H8V6h3v2Zm1-2h2v2h-1v1h-1V6Zm0 8h-2v1h1v-1Zm0-5h1v1h-1v-1Zm-6 4h1v-1H5v1Zm10 0h1v-1h-1v1Zm-5 0h1v-1h-1v1Z"
                ></path>
              </svg>
              <span class="flex-1 ms-3 whitespace-nowrap">Product1</span>
              <span
                v-if="user.rol !== 'manager'"
                class="inline-flex items-center justify-center w-3 h-3 ms-3 rounded-full bg-red-100 dark:bg-red-900"
              ></span>
            </a>
          </li>
        </ul>
